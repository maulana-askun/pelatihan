...
?>">
 ...
 <input type="text" name="tempat_lahir" value="<?php echo $row['tempat_lahir'] ?>" placeholder="Masukkan Tempat Lahir Siswa" class="form-control">
 </div>

 <div class="form-group">
 <label>TGL LAHIR</label>
 <input type="date" name="tgl_lahir" value="<?php echo $row['tgl_lahir'] ?>" placeholder="Masukkan Tanggal Lahir Siswa" class="form-control">
 </div>
 ...
 <script 
src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></scri
pt>
 </body>
</html>